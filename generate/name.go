...
var (
	adjectives = []string{
		...
		"important", "inexpensive", "mealy", "odd", "poor", "powerful", "rich", "shy", "tender",
		...
		"attractive", "bald", "beautiful", "clean", "dazzling", "elegant", "fancy", "fit",
		"graceful", "greasy", "grieving", "gritty", "grotesque", "grubby", "grumpy", "handsome", "happy", "hollow",
		"quaint", "scruffy", "shapely", "short", "skinny", "stocky", "ugly", "unkempt", "unsightly",
		"friendly", "frightened", "glorious", "gorgeous", "happy", "harebrained", "healthy",
		"helpful", "helpless", "high", "hollow", "homely", "large", "lazy", "livid", "lonely", "loose", "lovely", "lucky",
		"alive", "better", "careful", "clever", "dead", "easy", "famous", "gifted", "hallowed", "helpful",
		"mysterious", "narrow", "nasty", "outrageous", "panicky", "perfect", "perplexed", "quizzical", "teeny", "tender", "tense",
		"terrible", "tricky", "troubled", "unsightly", "upset", "wicked", "yummy", "zippy",
	}
	nouns = []string{
		"table", "chair", "vacuum", "man", "boy", "river", "cloud", "beach", "party", "ball", "bat",
		...
		"brother", "father", "milk", "coffee", "bed", "plant", "tree", "horse", "wall", "cat", "monkey",
		"dog", "roof", "king", "queen", "shoe", "park", "bird", "pond", "duck", "farmer", "cow", "computer", "fan", "television",
