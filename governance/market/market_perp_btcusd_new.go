...
const PerpetualBTCUSDNew = "auto:btc_usd_r"

func NewBTCUSDPerpetualMarketProposal_New(
	...
	return &commandspb.ProposalSubmission{
		...
		Rationale: &vega.ProposalRationale{
			Title:       "New BTC USD-R Incentive I",
			Description: "New BTC USD-R Incentive It",
		},
