				...
				NewMarket: &vega.NewMarket{
					Changes: &vega.NewMarketConfiguration{
						MarkPriceConfiguration: &vega.CompositePriceConfiguration{
							CompositePriceType:       vega.CompositePriceType_COMPOSITE_PRICE_TYPE_MEDIAN,
							DecayWeight:              "1.0",
							DecayPower:               1,
							CashAmount:               "5000000",
							SourceWeights:            []string{"1.0", "1.0", "1.0"}, // if not work get rid of weights and staleness
							...
							Product: &vega.InstrumentConfiguration_Perpetual{
								Perpetual: &vega.PerpetualProduct{
									InternalCompositePriceConfiguration: &vega.CompositePriceConfiguration{
										...
										DecayPower:               1,
										CashAmount:               "50000000",
										SourceWeights:            []string{"0.0", "0.999", "0.001"},
										SourceStalenessTolerance: []string{"1m", "1m", "10m"},
									},
									...
									SettlementAsset:          MainnetAssetID,
									QuoteName:                "USDT",
