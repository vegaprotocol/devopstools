...
func (w *EthWallet) GetTransactOpts(ctx context.Context) *bind.TransactOpts {
...
func NewWallet(ctx context.Context, ethClient *ethclient.Client, cfg config.EthereumWallet) (*EthWallet, error) {
