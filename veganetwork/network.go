...
type VegaNetwork struct {
	...
	SecondaryEthereumConfig        *vega.SecondaryEthereumConfig
...
func (n *VegaNetwork) EthClientForChainID(chainID string) *ethclient.Client {
	...
	case n.SecondaryEthereumConfig.ChainId:
...
func (n *VegaNetwork) RefreshNetworkParams() error {
	...
	n.PrimaryEthereumConfig, err = n.NetworkParams.GetPrimaryEthereumConfig()
	if err != nil {
	...
	n.SecondaryEthereumConfig, err = n.NetworkParams.GetSecondaryEthereumConfig()
	if err != nil {
